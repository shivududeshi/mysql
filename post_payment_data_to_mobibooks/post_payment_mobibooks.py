...
class PostPaymentToMobibooks:
    ...
    def __init__(self):
        ...
        print('{}-{}-{}-{}-{}'.format(self.loc,self.user,self.password,self.host,self.cust))
    ...
    def post_payment(self,payment_data):
        ...
        # for inv in invoice:
        # post and print paymen
        print('----BEFORE POSTING AN PAYMENT-----')
        # print(inv)
        resp = o.post('voucher/receipt/',payment_data)
        print('payment_response-{}'.format(resp))
# event={
#   "cart": {
#     "Items": [
#       {
...
#     x.consume_one_handler(post_payment_data)
...
#         # res=client.send_message(QueueUrl=f'https://sqs.us-east-1.amazonaws.com/{customer_id}/{queue_name}',MessageBody=error_message.args[0],MessageGroupId='PaymentError')
